...
class ZaloAuth extends BaseController
{
    ...
    public function authorize(): ResponseInterface
    {
        ...
        // Must use /v4/oa/permission (OA scope), not /v4/permission (social scope)
        return redirect()->to(self::OAUTH_BASE . '/oa/permission?' . $params);
    }
    ...
    private function exchangeCodeForToken(string $code): array
    {
        ...
        log_message('info', "[ZaloAuth] OA token exchange app_id=$appId redirect_uri=$redirectUri");
